...
//        // Remove existing marker if it exists
//        if (this.marker) {
//            this.planet.orbitGroup.remove(this.marker);
//            this.marker = null;
//        }
//
//        // Create new marker
...
//            this.marker = new THREE.Sprite(material);
//
//            // Add marker to the planet's orbit group
////            this.planet.orbitGroup.add(this.marker);
//            this.planet.scene.add(this.marker);
//
//
//        }
...
//        const z = this.planet.orbitRadius * Math.sin(this.angle);
//
//        // Position the marker slightly above the orbital plane
//        this.marker.position.set(x, this.planet.radius * 3, z);
//
//        // Scale the marker based on planet radius
//        this.marker.scale.set(this.planet.radius * 5, this.planet.radius * 5, 1);
//    }
//
//    setVisible(visible) {
